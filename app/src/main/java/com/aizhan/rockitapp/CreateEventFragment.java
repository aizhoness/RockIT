...
public class CreateEventFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        whenedit = (EditText) view.findViewById(R.id.whenEdit);
        whereedit = (EditText) view.findViewById(R.id.whereEdit);
        ...
        savebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String when = whenedit.getText().toString().trim();
                String where = whereedit.getText().toString().trim();
                ...
                if (who.isEmpty()){
                    ...
                    Toast.makeText(getActivity(), "Please provide information about place", Toast.LENGTH_SHORT).show();
                }else{
                    if (when.isEmpty()){
                        when = "-/-/-";
                    }
                    ...
                    final OfferInfo offerInfo = new OfferInfo(offerid, who, when, where, salary, "-", about, "event");
