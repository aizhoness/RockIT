...
public class FanProfileActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fan_profile);
    ...
    public void signOut() {
        ...
        startActivity(new Intent(FanProfileActivity.this, LoginActivity.class));
        finish();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.profilemenu) {
            fragment = new FanProfileFragment();
        } else if (id == R.id.subscribesmenu) {
